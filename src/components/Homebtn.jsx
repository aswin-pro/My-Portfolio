...
function Homebtn(){
    ...
    return(
        ...
        <a href="#aboutme" className='text-center border border-x-2 border-black p-2 rounded-lg w-36 hover:border-[#d45050]'><button className=''>About Me</button></a>
