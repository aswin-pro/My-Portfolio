    ...
    return(
        <>
            <div className="m-3 border border-gray-200 p-2 pro-img hover:shadow-lg cursor-pointer">
                <div>
                    <img src={greendan} alt="" className=" " />
                    <h1 className="text-center font-medium text-xl mt-1">Greendan</h1>
                ...
                <div className="mt-4 flex justify-center gap-2 mb-5">
                    <a href="https://aswin-pro.github.io/Greenden-Tailwind/" target="_blank" className="text-center border border-x-2 border-red-500 p-1 px-6 rounded-lg w-36"><button>Live</button></a>
                    <a href="https://github.com/aswin-pro/Greenden-Tailwind" target="_blank" className="text-center border border-x-2 border-red-500 p-1 px-6 rounded-lg w-36 bg-red-500 text-white"><button>Repo </button></a>
                </div>
            </div>
        </>
    )
